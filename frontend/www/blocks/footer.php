...
<div class="row">
    <div class="col-1-of-2">
        <div class="footer__navigation">
            ...
            <?php
             $header_links = array('Acasa' => 'index', 'Despre noi' => 'despre-noi', 'Produse' => 'produse', 'Blog' => 'blog', 'Termeni si conditii' => 'termeni-si-conditii', 'Prelucrarea datelor cu caracter personal' => 'prelucrarea-datelor-cu-caracter-personal', 'Contact' => 'contact');
